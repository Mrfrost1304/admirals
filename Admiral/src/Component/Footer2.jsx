...
export default function AdmiralsDisclaimerFooter() {
  return (
    <footer className="bg-gray-50 text-gray-600 text-sm leading-relaxed">
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-6">
        ...
        <p>
          <strong className="text-gray-800">Risk warning:</strong> The information on the website is not targeted to any country or jurisdiction where such distribution or use would be contrary to local law or regulation. Admirals SC Ltd (Registration Number 8426894-1) has the necessary license and approval to operate under the brand "Admirals". "Admirals SC Ltd or Admirals" where for the purpose of this website reference to either shall constitute actions of Admirals SC Ltd. Admirals SC Ltd is licensed by the Financial Services Authority of Seychelles (FSA) as a Securities Dealer in Seychelles under license number SD073.
        </p>
        ...
        <p>
          <strong>Address:</strong> Suite 202, Second Floor, Waterside Property, Eden Island, Mahé, Seychelles with a right to operate under the name Admirals as Franchisee.
        </p>
        ...
        <p>
          Card transactions are processed by our business partner, Pemax Services Ltd (Registration No. HE 320715), whose registered and business office address is situated at Archiepiskopou Makariou III, 88, Floor 1, 1077, Nicosia, Cyprus.
        </p>

        <div className="flex justify-end">
          <a href="/privacy-policy" className="text-gray-800 font-medium hover:underline">
            Privacy Policy
          </a>
        </div>
      </div>
